CREATE TABLE Employee(employee_id INT PRIMARY KEY IDENTITY(100,5),
...
-- Q-10
ALTER TABLE Employee ADD CONSTRAINT DF_AGE DEFAULT 26 FOR age;
...
-- Q-15
SELECT name,CHARINDEX('a',name) AS position_of_a FROM Employee;
